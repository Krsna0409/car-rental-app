...
export function HomeScreen() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-background via-background to-accent/5 pb-20">
      {/* Header */}
      <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-md px-4 py-4 border-b border-border/50">
        <div className="flex items-center justify-between animate-slide-in-down">
          <button 
            onClick={() => setCurrentScreen("location")}
            className="flex items-center gap-2 rounded-full hover:bg-secondary/70 px-2 py-1 transition-all duration-300 ease-in-out hover:scale-105 active:scale-95"
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-secondary to-accent hover:shadow-lg transition-all duration-300 ease-in-out">
          ...
          <button 
            ...
            className="relative flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-secondary to-accent hover:shadow-lg transition-all duration-300 ease-in-out hover:scale-110 active:scale-95"
          >
            <Bell className="h-5 w-5 text-foreground hover:text-primary transition-all duration-300 ease-in-out" />
            ...
            <button
              ...
              className={cn(
                ...
                selectedCategory === category
                  ...
                  : "bg-secondary text-foreground hover:bg-secondary/80 border-2 border-transparent hover:border-primary/30"
              )}
            >
              {category}
            </button>
